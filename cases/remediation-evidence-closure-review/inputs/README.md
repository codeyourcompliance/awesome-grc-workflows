...
These files form the complete evidence package for the case. No hidden evidence is required.

| File | Purpose |
| --- | --- |
| `01-issue-record.md` | Issue scope, cause, risk, and status |
...
| `09-management-representation.md` | Management assertion |
