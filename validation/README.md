...
The validator reports only what it checks. `PRIVATE_LAYER_REFERENCES_IN_TEMPLATE=0` means the scanned template files contain none of the defined private-layer or recruitment markers. It does not prove that a cross-repository transfer did or did not occur.
