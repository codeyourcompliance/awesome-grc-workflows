...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Northern Trust | Senior IT Analyst - Global Financial Controls | [Official employer page](https://ntrs.wd1.myworkdayjobs.com/en-GB/northerntrust/job/Senior-IT-Analyst---Global-Financial-Controls_R155096) | 2026-08-03 | 2026-08-03 | active | Validates remediation effectiveness and closure of control deficiencies within a wider independent control-testing role. | Counted once at Northern Trust Corporation level. The work pattern was first observed through an attributable job-board copy on 2026-07-31; other Northern Trust roles do not increase the count. |
